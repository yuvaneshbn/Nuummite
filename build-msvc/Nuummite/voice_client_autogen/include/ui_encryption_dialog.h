...
public:
    ...
    void setupUi(QDialog *EncryptionDialogForm)
    {
        ...
        EncryptionDialogForm->resize(380, 140);
    ...
    void retranslateUi(QDialog *EncryptionDialogForm)
    {
        ...
        promptLabel->setText(QCoreApplication::translate("EncryptionDialogForm", "Enter Private Room Passphrase (Not transmitted):", nullptr));
        passphraseEdit->setPlaceholderText(QCoreApplication::translate("EncryptionDialogForm", "Passphrase Key", nullptr));
    } // retranslateUi
